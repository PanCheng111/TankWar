...
func didConnecting(myPeerID: MCPeerID, peer: MCPeerID) {
    NSLog("did connecting....\(myPeerID.displayName) with \(peer.displayName)\n")
    NSLog("on connecting...\(onConnecting)\n")
...
func didConnect(myPeerID: MCPeerID, peer: MCPeerID) {
    NSLog("did connected \(myPeerID.displayName) with \(peer.displayName)")
    if session == nil {
